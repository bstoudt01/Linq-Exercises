    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            //includes public class Customer listed at the bottom of this .cs file
            ...
            List<string> millionaires = new List<string>();
            System.Collections.IList list = customers;
            for (int i = 0; i < list.Count; i++)
            {
                Customer customer = (Customer) list[i];
                if (customer.Balance >= 1000000)
                {
                    millionaires.Add(customer.Name);

                }

            }
            foreach (string millionaire in millionaires)
            {
                Console.WriteLine($"Another Millionaire: {millionaire}");
